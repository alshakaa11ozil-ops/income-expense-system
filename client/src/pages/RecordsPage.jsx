    ...
    useEffect(() => {
        async function load_records() {
            ...
            try {
                ...
                show_toast('Failed to load records. Please try again.', 'error')
            } finally {
                setIsLoading(false)
            }
        }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-5">
                ...
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="px-2.5 py-0.5 rounded-full bg-slate-200 text-slate-600 text-sm font-medium">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-300 bg-white text-slate-700 text-sm font-medium hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
                            {is_exporting ? (
                ...
                {period_summary && (
                    <div className="flex flex-wrap items-center gap-x-6 gap-y-1 bg-white rounded-xl border border-slate-200 px-5 py-3 text-sm">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 py-2.5 px-4 rounded-xl border border-slate-300 text-slate-700 text-sm font-medium hover:bg-slate-50 transition-colors disabled:opacity-50"
                            >
                                Cancel
                            </button>
                            <button
